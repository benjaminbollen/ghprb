...
public class GhprbBuilds {
    ...
    public String build(GhprbPullRequest pr) {
        ...
        GhprbCause cause = new GhprbCause(pr.getHead(), pr.getId(), pr.isMergeable(), pr.getForkAuthor(), pr.getTaskLabel(), pr.getTarget(), pr.getSource(), pr.getAuthorEmail(), pr.getTitle(), pr.getUrl());
